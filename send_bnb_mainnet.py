...
def send(receiver_address: str, sender_address: str) -> str:

    """
        Send BNB MAINNET from 'sender_address' to 'receiver_address'
    ...
    print(f"$BNB: {w3.fromWei(w3.eth.get_balance(add1), 'ether')} BNB")
